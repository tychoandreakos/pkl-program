            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu"><li><i class="fa fa-plus"></i><a href="ui-buttons.html">Daftar Pegawai</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon ti-printer"></i>Cetak Data</a>
                    ...
                    <li>
                        <a href="widgets.html"> <i class="menu-icon ti-email"></i>About</a>
					</li>
					<li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="<?= base_url('assets/images/logo.jpg') ?>" alt="Logo"></a>
                    <a class="navbar-brand hidden" href="./"><img src="<?= base_url('assets/images/logo2.jpg') ?>" alt="Logo"></a>
                                        ...
                                        <table class="table ">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="avatar">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="<?= base_url('assets/images/avatar/1.jpg') ?>" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5469 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="avatar">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="<?= base_url('assets/images/avatar/2.jpg') ?>" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5468 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="avatar">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="<?= base_url('assets/images/avatar/3.jpg') ?>" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5467 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="avatar">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="<?= base_url('assets/images/avatar/4.jpg') ?>" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5466 </td>
                                                ...
                                                <tr class=" pb-0">
                                                    ...
                                                    <td class="avatar pb-0">
                                                        <div class="round-img">
                                                            <a href="#"><img class="rounded-circle" src="<?= base_url('assets/images/avatar/5.jpg') ?>" alt=""></a>
                                                        </div>
                                                    </td>
                                                    <td> #5465 </td>
                                        ...
                                        <ul>
                                            <li>
                                                <div class="msg-received msg-container">
                                                    <div class="avatar">
                                                       <img src="<?= base_url('assets/images/avatar/64-1.jpg') ?>" alt="">
                                            ...
                                            <li>
                                                <div class="msg-sent msg-container">
                                                    <div class="avatar">
                                                       <img src="<?= base_url('assets/images/avatar/64-2.jpg') ?>" alt="">
                                                       <div class="send-time">11.11 am</div>
                                                    </div>
                                                    <div class="msg-box">
                                                        <div class="inner-box">
