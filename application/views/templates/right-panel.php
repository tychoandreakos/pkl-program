        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="<?= base_url('assets/images/logo.jpg') ?>" alt="PT NRMetal"></a>
                    <a class="navbar-brand hidden" href="./"><img src="<?= base_url('assets/images/logo2.jpg') ?>" alt="Logo"></a>
                    <a id="menuToggle" class="menutoggle"><i class="ti-menu"></i></a>
                </div>
            </div>
            <div class="top-right">
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar" style="background-image: url(<?= site_url('upload/avatar/') . $user['avatar']; ?>)">
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?= site_url('dashboard/profile/') . $user['username'] ?>">My Profile</a>
